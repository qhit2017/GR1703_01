SELECT * FROM student
DELETE FROM student
INSERT INTO student (no,name,sex,age,dept)VALUES('01','令狐冲','男',20,'园艺');
...
INSERT INTO student VALUES ('07','曲非烟','女',15,'计算机',94);
INSERT INTO student VALUES ('08','刘芹','男',15,'计算机',60);
INSERT INTO student VALUES ('09','东方不败','男',37,'语教',89);
...
from student a
WHERE  a.grade>(SELECT AVG(a.grade) FROM student a)

--13.	查询专业学生人数超过50人的专业名。
SELECT dept,COUNT(*) as '人数'
from student
 where 50<=(select count(*)from student) GROUP BY dept HAVING 50<=COUNT(*)

--14.	查询“计算机”专业未成年学生的平均成绩和专业名。
SELECT a.dept, AVG(a.grade)
from student a
WHERE a.age<16 AND a.dept ='计算机'
GROUP BY a.dept
SELECT  dept,COUNT(*)
FROM student
GROUP BY dept
