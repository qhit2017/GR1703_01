...
insert into Student2 (Sname,Sno,Sage)values('崔耀威',1,20)
...
select Sname ,Ssex
from Student2 
where Sdept='信息'  or Sdept ='数学' or Sdept = '计算机'

--11.	查询既不是信息系、数学系，也不是计算机科学系的学生的姓名和性别。
select Sname,Sage
from Student2
where Sdept!='信息' and Sdept!='数学'and Sdept!='计算机'
