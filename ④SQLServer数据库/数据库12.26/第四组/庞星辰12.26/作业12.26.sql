...
from Course a INNER JOIN SC s ON a.cno=s.cno
AND s.sno='200215121'

--27、	求各个课程号及相应的选课人数。
select a.cno, COUNT (a.cno) as '选课人数'
from SC a
GROUP BY a.cno

--28、	查询选修了3门以上课程的学生学号。
select c.sno 
from Course  a LEFT JOIN SC  s ON a.cno=s.cno LEFT JOIN student c ON c.sno=s.sno
GROUP BY s.sno 
